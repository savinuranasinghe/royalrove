export const travelNavigation = [
  ...
  { label: "Our Curated Stays", href: "/hotels" },
...
export const experiences = [
  ...
  { slug: "beach-island-escapes", title: "Beach & Island Escapes", line: "Stay for the sunset.", image: "/images/map/unawatuna.webp", alt: "A peaceful coastal setting in Sri Lanka", description: "Choose a surf town, a quiet bay, or a long stretch of sand—and settle into coastal life.", activities: ["Mirissa", "Hiriketiya", "Arugam Bay", "Pasikudah", "Bentota", "Trincomalee"], journey: "southern-soul" },
  { slug: "wellness-escapes", title: "Wellness & Escapes", line: "Time to simply be.", image: "/images/map/welness.webp", alt: "A peaceful wellness retreat setting in Sri Lanka", description: "Gentler days, restorative rituals, and space to reconnect at your own pace.", activities: ["Yoga", "Ayurveda", "Wellness retreats", "Private villas", "Slow travel"], journey: "island-in-style" },
...
export const journeyImage = (image: string) => image.startsWith("/") ? image : `/images/${["beach", "waterfall", "train"].includes(image) ? "travel" : "map"}/${image}.webp`;
